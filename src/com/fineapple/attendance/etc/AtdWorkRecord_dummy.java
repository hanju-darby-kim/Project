...
public class AtdWorkRecord_dummy
{
    ...
    public static void getWrSql(int employeeSeq)
    {
        ...
        for (i = 1; i <= 31; i++)
        {
            ...
            String insert = String.format(
                    "insert into atdWorkRecord (seq, eseq, comeTime, leaveTime) values (%s, %s, to_date('%s', 'yyyy-mm-dd hh24:mi'), to_date('%s', 'yyyy-mm-dd hh24:mi'));",
    ...
    public static void getWcmSql(int employeeSeq)
    {
        ...
        for (i = 1; i <= 31; i++)
        {
            ...
            String insert = String.format("insert into atdWrCtgManage (seq, wrseq, cseq) values (%s, %s, %s);", seq,
                    wrseq, cseq);
