...
(function(h) {
    ...
    function pb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="' + b.sFilterInput + '"/><div class="form-group" style="width:70px;"><select class="form-control"><option>전체</option><option>일반</option><option>질문</option><option>건의</option></select></div>',
            j = d.sAtdBoardSearch,
    ...
    m.defaults = {
        ...
        aaSortingFixed: [],
        ajax: null,
        //10, 25, 50, 100 -> 초기값 25을 위해, 25, 50, 100 으로 변경
        ...
        oLanguage: {
            ...
            sEmptyTable: "게시글이 존재하지 않습니다",
            //sInfo: "Showing _START_ to _END_ of _TOTAL_ entries",
            sInfo: "현재페이지 <span style='color:#F0AD4E'>_START_ ~ _END_</span> 번 / 전체 <span style='color:#5CB85C'>_TOTAL_</span> 개",
            //sInfoEmpty: "Showing 0 to 0 of 0 entries",
            sInfoEmpty: "현재페이지 0 ~ 0 번 / 전체 0 개",
